function setupDatabase() {
  ...
  const sheetsInfo = [
    ...
    { name: 'DB Master Barang Jadi', cols: ['Kode Barang', 'Nama Barang', 'Stok', 'Harga Jual'] },
    ...
    { name: 'DB SPK Produksi', cols: ['No SPK', 'Tanggal', 'Kode Barang Jadi', 'Qty Produksi', 'Peminta', 'Pemberi', 'Status'] },
    { name: 'DB Penawaran', cols: ['No Penawaran', 'Tanggal', 'Customer', 'Rincian Item', 'Total Harga', 'Down Payment', 'Status', 'Narasi'] },
